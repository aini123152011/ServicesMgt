...
| 服务 | 用途 | 容器内端口 | 宿主发布（统一范围 + 标准端口） | 生效方式 |
| --- | --- | --- | --- | --- |
| chrony | NTP 时间同步 | 123/udp | 18101、123 | 热 |
| nginx | HTTP / HTTPS 文件服务 | 80、443 | 18102、18103 | 热 |
| rsyslog | BMC 日志归集 | 514/tcp+udp | 18104、514 | 重启 |
| webdav | WebDAV 文件共享 | 8080 | 18105 | 重启 |
| sftp | SFTP 文件传输 | 22 | 18106 | 重启 |
| vsftpd | FTP 文件共享 | 21、40000-40100 | 18107、21、40000-40100 | 重启 |
| tftpd-hpa | TFTP 文件传输 | 69/udp | 18108、69 | 重启 |
| samba | Samba / CIFS 文件共享 | 445 | 18109、445 | 重启 |
| nfs-ganesha | NFS 网络文件系统 | 2049 | 18110、2049 | 重启 |
| snmptrapd | SNMP Trap 接收 | 162/udp | 18111、162 | 重启 |
| postfix | SMTP 邮件中继 | 25 | 18112、25 | 重启 |
